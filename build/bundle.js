...
/***/ function(module, exports, __webpack_require__) {
	...
	var getImage = function getImage() {
	  ...
	  _superagent2.default.get(apod).end(showImage);
	};
	
	var testFunc = function testFunc(x) {
	  return console.log('The testFunc is working: ', x);
	};
	
	var testFill = function testFill(word) {
	  return Array.fill(word);
	};
	
	var testFrom = function testFrom(word) {
